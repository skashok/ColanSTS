...
- (void)setup
{
	...
	self.toggleLayer = [[[[[self class] toggleLayerClass] alloc] initWithOnString:@"YES" offString:@"NO" onTintColor:[UIColor colorWithRed:0.000 green:0.478 blue:0.882 alpha:1.0]] autorelease];
